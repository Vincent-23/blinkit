...
const FooterDownloadContent = ({ className="" }) => {
  return (
    <VerticalContainer className={classNames(styles.container, className)}>
        ...
        <Logo className={classNames(styles.imageItem, className)} image={"https://blinkit.com/d61019073b700ca49d22.png"}/>
        <Logo className={classNames(styles.imageItem, className)} image={"https://blinkit.com/8ed033800ea38f24c4f0.png"}/>
